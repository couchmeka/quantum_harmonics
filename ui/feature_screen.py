...
class FeatureScreen(QWidget):
    ...
    def open_harmonics(self):
        try:
            ...
            # Create harmonics screen
            harmonics_screen = HarmonicsScreen(self.quantum_tabs)
            if harmonics_screen is None:
                raise ValueError("Failed to create HarmonicsScreen")

            # Add to main layout
            self.main_layout.addWidget(harmonics_screen)
    ...
    def open_ai(self):
        try:
            ...
            # Create AI analysis screen with data manager
            from storage.data_manager import QuantumDataManager

            data_manager = QuantumDataManager()  # This will get the singleton instance
            ai_screen = AIAnalysisScreen(data_manager=data_manager)
    ...
    # Add placeholder methods for new features
